                    ...
                    <form action="{{ route('articles.update', $article) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Enter your title"
                                aria-describedby="helpId" value="{{ old('title', $article->title) }}" />
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="text" id="text" cols="20" rows="10" class="form-control" placeholder="Content">{{ old('text', $article->text) }}</textarea>
                            @error('text')
                                <p style="color: red;">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="author" class="form-control" placeholder="Enter your author"
                                aria-describedby="helpId" value="{{ old('author', $article->author) }}" />
                            @error('author')
                                <p style="color: red;">{{ $message }}</p>
                            @enderror
                        </div>
